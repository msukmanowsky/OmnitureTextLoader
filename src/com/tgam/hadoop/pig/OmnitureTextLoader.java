...
public class OmnitureTextLoader extends LoadFunc implements LoadMetadata {
	...
	public Tuple getNext() throws IOException {
		...
		// Quick check to ensure that we have the right number of values just in case
		if (values.length != FIELD_COUNT)
			throw new IOException("Error: Expected " + FIELD_COUNT + " fields but instead found only " + values.length + ".\n" + value.toString());
